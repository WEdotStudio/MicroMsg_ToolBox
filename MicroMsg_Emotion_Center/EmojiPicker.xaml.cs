...
{
    public partial class EmojiPicker : PhoneApplicationPage
    {
        ...
        private void Button_Click_1(object sender, System.Windows.Input.GestureEventArgs e)
        {
            ...
            byte[] thumb = readRes("Res/wnmdebz_thumb/" + data + ".png");
            byte[] emoji = readRes("Res/wnmdebz/" + data + ".png");
            WXEmojiMessage msg = new WXEmojiMessage();
            msg.Title = "微信工具箱,只属于WP";
            msg.Description = "王尼玛の暴走";
            msg.ThumbData = thumb;
            msg.EmojiData = emoji;
